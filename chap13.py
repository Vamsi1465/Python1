...
Original file is located at
    https://colab.research.google.com/github/AllenDowney/ThinkPython/blob/v3/chapters/chap13.ipynb
...
def replace_all(pattern_string,replacement_string,input_filename,output_filename):
    ...
    outfile.close()
    print("replacement string", output_filename)
