...
Original file is located at
    https://colab.research.google.com/github/AllenDowney/ThinkPython/blob/v3/chapters/chap12.ipynb
...
def count_trigram(word):
  ...
  for i in range(len(word) - 2):
    trigram_counter =  word[i] + word[i+1] + word[i+2]
    if trigram_counter not in trigram_counter:
      trigram_counter = trigram_counter[i]
    else:
      trigram_counter = trigram_counter[i] + 1
...
def add_trigram(words,successor_map):
  key = (words[0] + words [1])
  successor = words[2]
...
# Add trigrams
add_trigram(["the", "quick", "brown"], successor_map)
add_trigram(["the", "quick", "fox"], successor_map)
add_trigram(["quick", "brown", "fox"], successor_map)

# Display the successor map
print(successor_map)
