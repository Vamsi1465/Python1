...
Original file is located at
    https://colab.research.google.com/github/AllenDowney/ThinkPython/blob/v3/chapters/chap18.ipynb
...
def can_spell(tiles, word):
    ...
    for letter, count in word_count.items():
        if tiles_count[letter] < count:
            return False
    return True
tiles = "TABLE"
word1 = "BELT"
word2 = "BEET"
print(f"Can spell '{word1}':", can_spell(tiles, word1))  # True
print(f"Can spell '{word2}':", can_spell(tiles, word2))  # False
